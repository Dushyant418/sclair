            ...
            <Container>
                <div className="d-flex flex-column  align-items-center pt-lg-86 pt-sm-80 pt-60 pb-lg-85 pb-sm-80 pb-60 z-1 position-relative" data-aos="fade-up" >
                    ...
                    <div className="copy-box d-flex  w-100 position-relative">
                        <input type="text" placeholder='0xFD1929755F73f974648daD00ab491a7C44a00eeD' className='font-manrope fw-normal lh-24  fs-16 w-100 bg-transparent  border-0 outline-none white-smoke p-12' />
                        <Commonbtn name="Copy" />
                    </div>
